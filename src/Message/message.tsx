...
import { faCircleXmark, faCircleCheck, faCircleInfo, faTriangleExclamation } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="p-4 w-80">
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1 pt-0.5">
              {title && <p className="text-sm font-medium text-gray-900 mb-1">
                {title}
              </p>
              }
